...
def create_temporary_file(infile, outfile, globalbud, strength, labelshift):
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='creates temporary files for node classification problems')
    ...
    parser.add_argument('globalbud', metavar="globalbud", type=int, help='global attack budget')
    ...
    create_temporary_file(args.inputfile, args.outputfile, args.globalbud, args.strength, args.labelshift)
