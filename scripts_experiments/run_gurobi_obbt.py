...
if __name__ == "__main__":
    ...
    f.write('gnn/robustclassify/useenhancedbounds = TRUE\n')
    f.write('gnn/robustclassify/useobbt = TRUE')
    f.close()
    ...
    # subprocess.run(["rm", f"{tmp_instance}"])
    ...
    if has_solution:
        ...
        # subprocess.run(["rm", f"{tmp_sol_file}"])
